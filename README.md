...
See Humason_Description.docx in the Humason folder for a complete description.

Download, extract and install (setup.exe) the latest version from the Humason/Publish/Humason64Build270.zip (or later) file
